...
def get_all_artists():
    ...
    try:
        ...
        df_meta = pd.read_csv(f"https://docs.google.com{SHEET_ID}/export?format=xlsx", engine='openpyxl')
...
ARTIST_LIST = ["KenMiyake", "HiromitsuKitayama", "Number_i"] # ➔ あなたのシート名（タブ名）に書き換えてください
